...
class Appointment:
	...
	def show_aptmnt(self,Patient_ID,Date,Fname,Lname):
		...
		cursor=cnx.cursor()
		query="select aptmnt.Aptmnt_ID,aptmnt.Doctor_ID,doctors.First_Name,doctors.Last_Name,'{}','{}',doctors.Specialization,DATE_FORMAT(aptmnt.Date,'%Y-%m-%d'),aptmnt.Slot from aptmnt,doctors where aptmnt.Doctor_ID=doctors.Doctor_ID and aptmnt.Patient_ID='{}' and aptmnt.Date>='{}' order by aptmnt.Date,aptmnt.Slot;".format(Fname,Lname,Patient_ID,Date)
